...
export const BaseModal = ({
  ...
  return (
    <div className="fixed inset-0 z-10 flex items-center justify-center bg-mauve-900/25 backdrop-blur-[4px] p-4">
      <div
        className="bg-mauve-100 rounded max-w-[569px] max-h-[calc(100vh-2rem)] w-full p-4 relative z-20 overflow-auto scrollbar-thin animate-slide-up-fade"
        role="dialog"
        aria-modal="true"
      >
